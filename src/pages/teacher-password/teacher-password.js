...
import styles from './teacher-password.module.scss';
...
// Actions
import { changePasswordTeacher } from '../../stores/actions/ActionTeacher';

const TeacherPasswordPage = () => {
  ...
  const handleChangePassword = async (data) => {
    dispatch(changePasswordTeacher(teacher_id, data, setNotification, setView));
  };
      ...
      <div className={styles.content}>
        {view === 'password' ? (
          ...
          <>
            ...
            <Button variant={'primary'} type={'button'} onClick={() => navigate('/teacher-login', { replace: true })}>{'Click here to login as Teacher'}</Button>
          </>
        )}
      </div>
    </section>
...
export default TeacherPasswordPage;
